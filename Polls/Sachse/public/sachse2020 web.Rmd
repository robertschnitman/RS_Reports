---
title: Using the R Programming Language to Report the Sachse, TX January 2020 Special Election Pre-runoff Results
...
link-citations: yes
description: "The purpose of this document is to demonstrate the utility of using the R programming language in reporting polls by walking through the process via the software itself." 
---
